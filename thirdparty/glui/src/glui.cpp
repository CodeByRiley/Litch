...
//					}
				...
				switch (widget.type)
				{
					...
					case widgetType::toggle:
					{
						...
						toggleTransform.x = (p.x + widget.spacing) + p.z;

						glm::vec4 aabbBox = p;
						aabbBox.z += toggleTransform.z;
						aabbBox.y = std::min(toggleTransform.y, textTransform.y);
						aabbBox.w = std::max(toggleTransform.w + widget.spacing, textTransform.w);
                        ...
                        renderer.renderRectangle(toggleTransform,widget.texture, Colors_Transparent);

                        renderer.renderRectangle(toggleTransform,widget.texture, Colors_Black);
                    ...
                    case widgetType::dualtoggle:
                    {
                        ...
                        toggleTransform.x = (p.x + widget.spacing) + p.z;
                        glm::vec4 aabbBox = p;
                        aabbBox.z += toggleTransform.z + (widget.spacing);
                        aabbBox.y = std::min(toggleTransform.y, textTransform.y);
                        aabbBox.w = std::max(toggleTransform.w, -toggleTransform.w);

                        renderer.renderRectangle(aabbBox, Colors_Red);
                        if (aabb(aabbBox, input.mousePos))
                        {
                            hovered = true;
                            if (input.mouseHeld)
    ...
    bool RendererUi::Button(std::string name, Sound* click)
    {
        name += internal.idStr;
        ...
        widget.sound = click;
        widget.type = widgetType::button;
        widget.colors = Colors_Transparent;
        widget.texture = {};
        widget.usedThisFrame = true;
        widget.justCreated = true;
        internal.widgetsVector.push_back({name, widget});
	...
	bool RendererUi::Toggle(std::string name, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture texture, const gl2d::Texture overTexture, float spacing)
	{
		name += internal.idStr;
        ...
        widget.sound = internal.defaultSound;
    ...
    bool RendererUi::Toggle(std::string name, Sound* sound, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture texture, const gl2d::Texture overTexture, float spacing)
    {
        name += internal.idStr;
    ...
    bool RendererUi::Toggle(std::string name, Sound* tick, Sound* untick, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture texture, const gl2d::Texture overTexture, float spacing)
    {
        name += internal.idStr;
    ...
    bool RendererUi::DualToggle(std::string name, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture tickedTex, const gl2d::Texture unTickedTex, float spacing)
    {
        name += internal.idStr;

        Internal::Widget widget = {};
        widget.type = widgetType::dualtoggle;
        widget.colors = colors;
        widget.sound = internal.defaultSound;
        widget.spacing = spacing;
        widget.usedThisFrame = true;
        ...
        widget.pointer = toggle;
        if(*toggle == true) {
            widget.texture = tickedTex;
        } else {
            widget.texture = unTickedTex;
        }
        internal.widgetsVector.push_back({name, widget});
    ...
    bool RendererUi::DualToggle(std::string name, Sound* sound, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture tickedTex, const gl2d::Texture unTickedTex, float spacing)
    {
        name += internal.idStr;
    ...
    bool RendererUi::DualToggle(std::string name, Sound* tick, Sound* untick, const gl2d::Color4f colors, bool* toggle, const gl2d::Texture tickedTex, const gl2d::Texture unTickedTex, float spacing)
    {
        name += internal.idStr;
    ...
    bool RendererUi::ToggleButton(std::string name, Sound* tick,Sound* untick, const gl2d::Color4f textColors,
		bool *toggle, const gl2d::Texture texture, const gl2d::Color4f buttonColors)
	{
		name += internal.idStr;
    ...
    void RendererUi::sliderFloatNoDecimal(std::string name, float *value, float min, float max,
                                 ...
                                 gl2d::Texture ballTexture, gl2d::Color4f ballColor)
    {
        ...
        Internal::Widget widget = {};
        widget.type = widgetType::sliderFloatND;
	...
	bool RendererUi::BeginMenu(std::string name, const gl2d::Color4f colors, const gl2d::Texture texture)
	{
		Internal::Widget widget = {};
...
//    void RendererUi::BeginMenu(std::string name, Sound* sound, const gl2d::Color4f colors, const gl2d::Texture texture)
//	{
//		Internal::Widget widget = {};
//		widget.type = widgetType::beginMenu;
//		widget.colors = colors;
...
//		widget.usedThisFrame = true;
//		widget.justCreated = true;
//        widget.shouldPlaySound = true;
//		internal.widgetsVector.push_back({name, widget});
//
//		PushIdInternal(*this, hash(name));
//	}
    bool RendererUi::BeginMenu(std::string name, Sound* sound, const gl2d::Color4f colors, const gl2d::Texture texture)
    {
        Internal::Widget widget = {};
        widget.type = widgetType::beginMenu;
        widget.colors = colors;
    ...
    void RendererUi::SetDefaultClickSound(Sound &sound)
    {
        internal.defaultSound = &sound;
    }
