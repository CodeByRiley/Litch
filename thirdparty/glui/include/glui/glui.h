...
namespace glui
{
	...
	struct RendererUi
	{
        ...
        bool Button(std::string name, Sound* click);
		...
		bool Toggle(std::string name,
			...
			const gl2d::Texture texture = {}, const gl2d::Texture overTexture = {}, float spacing = 0);
        bool Toggle(std::string name, Sound* sound,
			const gl2d::Color4f colors, bool *toggle,
			const gl2d::Texture texture = {}, const gl2d::Texture overTexture = {}, float spacing = 0);
        bool Toggle(std::string name, Sound* tick, Sound* untick,
			const gl2d::Color4f colors, bool *toggle,
			const gl2d::Texture texture = {}, const gl2d::Texture overTexture = {}, float spacing = 0);

        bool DualToggle(std::string name,
                    const gl2d::Color4f colors, bool *toggle,
                    const gl2d::Texture tickedTex = {}, const gl2d::Texture unTickedTex = {}, float spacing = 0);
        bool DualToggle(std::string name, Sound* sound,
                    const gl2d::Color4f colors, bool *toggle,
                    const gl2d::Texture tickedTex = {}, const gl2d::Texture unTickedTex = {}, float spacing = 0);
        bool DualToggle(std::string name, Sound* tick, Sound* untick,
                    const gl2d::Color4f colors, bool *toggle,
                    const gl2d::Texture tickedTex = {}, const gl2d::Texture unTickedTex = {}, float spacing = 0);
        ...
        bool ToggleButton(std::string name, Sound* tick, Sound* untick,
			const gl2d::Color4f textColors, bool *toggle,
			const gl2d::Texture texture = {}, const gl2d::Color4f buttonColors = {1,1,1,1});
        ...
        void sliderFloatNoDecimal(std::string name, float *value, float min, float max,
                         gl2d::Color4f textColor = {1,1,1,1},
                         gl2d::Texture sliderTexture = {}, gl2d::Color4f sliderColor = {1,1,1,1},
                         gl2d::Texture ballTexture = {}, gl2d::Color4f ballColor = {1,1,1,1});
		...
		bool BeginMenu(std::string name, const gl2d::Color4f colors, const gl2d::Texture texture);
        bool BeginMenu(std::string name, Sound* sound, const gl2d::Color4f colors, const gl2d::Texture texture);
		void EndMenu();
        ...
        void SetDefaultClickSound(Sound& sound);
		struct Internal
		{
			struct InputData
			{
